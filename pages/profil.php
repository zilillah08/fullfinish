        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                <?php
                // Pastikan user_data berisi informasi yang benar
                $profile_photo = !empty($user_data['profile_photo']) ? $user_data['profile_photo'] : 'default-profile.png'; 
                ?>
                <img src="../pages/assets/img/<?= htmlspecialchars($profile_photo) ?>" alt="Profile Photo" class="img-fluid rounded-circle">                <h2 class="brand-color"><?= htmlspecialchars($user_data['first_name'] . ' ' . $user_data['last_name']) ?></h2>
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <input type="hidden" name="updateProfile">
                                ...
                                <div class="row mb-3">
                                <label for="profile_photo" class="col-md-4 col-lg-3 col-form-label">Profile Photo</label>
                                <div class="col-md-8 col-lg-9">
